...
<section class="background_bg breadcrumb_section overlay_bg2 page-title-light" data-img-src="assets/images/favimg/formation.jpg">
    	...
    	<div class="row">
        	<div class="col-md-12">
            	<div class="heading_s1 text-center">
                	<h2>Nos Formations en Pattiserie</h2>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
        	<div class="col-lg-3 col-sm-6 mb-lg-5 mb-sm-4 pb-sm-1 pb-3 text-center">
            	<div class="team_box light_gray_bg">
                	<div class="team_img">
                    	<img src="assets/images/favimg/croissant-on-cutting-board-with-.jpg"  alt="team1"/>
                    </div>
                    <div class="team_title">
                        <h5>Pattiserie Générale</h5>
